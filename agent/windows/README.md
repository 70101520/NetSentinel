...
Versioning follows SemVer. This release reports `0.6.3`. CI produces both the self-contained binary bundle and a Windows Setup executable. Remote unattended update is intentionally absent.
