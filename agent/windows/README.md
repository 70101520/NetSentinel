...
Versioning follows SemVer. This release reports `0.4.2`. CI produces both the self-contained binary bundle and a Windows Setup executable. Remote unattended update is intentionally absent.
